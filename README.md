...
[![Deploy to Hatchable](https://hatchable.com/deploy-button.svg)](https://hatchable.com/deploy?repo=https://github.com/Shivaraj0500/Optionedge-AI)

AI-native options strategy research and paper-trading terminal for Indian index options, with Upstox connectivity, evidence-first market intelligence, and controlled progression from backtest to paper trading.
